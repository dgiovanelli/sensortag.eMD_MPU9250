...
//#include "board-st_discovery.h"	//Eliminado, es el equivalente a mi BIOS start, incluye delays y gettck

   
//#define i2c_write   SensorI2C_select(SENSOR_I2C_1,Board_MPU9250_ADDR); SensorI2C_writeReg ....go on
//#define i2c_read    SensorI2C_select(SENSOR_I2C_1,Board_MPU9250_ADDR); SensorI2C_readReg ....go on
